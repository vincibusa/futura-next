...
const ServicesSection = () => {
  ...
  return (
    <section id="servizi" className="py-24 bg-gradient-to-b from-white to-gray-50 relative overflow-hidden">
      <div className="absolute -top-40 -left-40 w-80 h-80 rounded-full bg-blue-50 opacity-40"></div>
      <div className="absolute -bottom-40 -right-40 w-80 h-80 rounded-full bg-blue-50 opacity-40"></div>
                ...
                <div className="p-8 flex flex-col flex-grow">
                  ...
                  <div className="mt-auto">
                    ...
                    <ul className="grid grid-cols-2 gap-y-2 gap-x-4 mb-6">
                      {service.subservices.map((subservice, index) => (
                        <li key={index} className="flex items-center text-gray-600 group-hover:text-gray-700 transition-colors">
                          <svg className="w-5 h-5 mr-2 text-blue-500 transition-transform duration-300 group-hover:scale-110" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    ...
                    <Link href={`/servizi/${service.id}`} className="inline-block">
                      <div
                        className="flex items-center text-blue-600 font-medium cursor-pointer group-hover:font-semibold hover:translate-x-1 transition-transform duration-300"
                      >
                        Scopri di più
                        <svg
